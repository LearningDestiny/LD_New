...
export async function POST(req) {
    try {
        ...
        // https://script.google.com/macros/s/AKfycbyZEOkr5gxDR89lBryMIhZCUME2tbvniB7s-v7v68dMiDtPiUctDBcpxzJptStolpClgw/exec
        // // Define the spreadsheet ID and the range where data will be appended
        // const SPREADSHEET_ID = process.env.JD_SPREADSHEET_ID;
