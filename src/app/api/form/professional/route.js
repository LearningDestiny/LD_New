...
const filePath = path.join(jsonDirectory, "professional.json");
...
export async function POST(request) {
  try {
    ...
    const textFields = {
      ...
      roleName: formData.get("professionalCareerName"),
      roleDescription: formData.get("professionalCareerDescription"),
      roleLocation: formData.get("professionalCareerLocation"),
      roleId: formData.get("professionalCareerId"),
    };
    ...
    const newEntry = {
      ...
      user: {
        ...
        currentEmployer: textFields.employer,
        skills: textFields.skills.split(',').map(skill => skill.trim()),
